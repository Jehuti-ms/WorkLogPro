// app.js - FIREBASE-READY COMPLETE REWRITE
// Maintains existing styling hooks and DOM IDs from your current UI.
console.log("📦 App.js loaded - Firebase Edition");
...
async function loadAllData() {
  try {
    ...
    if (typeof firebaseManager !== 'undefined' && firebaseManager.loadData) {
    ...
    if (loadedData) {
      // Use Firebase data
      console.log("✅ Data loaded from Firebase:", loadedData);
...
async function saveAllData() {
  try {
    ...
    if (typeof firebaseManager !== 'undefined' && firebaseManager.saveData) {
